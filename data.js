export const data = {
  english: {
    ...
    aboutMeBtn: "ABOUT ME",
    webDevelopmentText:
      "Create, build, and maintain your websites and web applications.",
    webDesignText:
      "Focus on aesthetic factors like layout, user interface and other visual imagery in order to make your website more visually appealing and easy to use.",
    appDesignText:
  ...
  italian: {
    ...
    aboutMeBtn: "SU DI ME",
    webDevelopmentText:
      "Crea, costruisce e gestisce i tuoi siti web e le tue applicazioni web",
    webDesignText:
      "Concentrazione su fattori estetici come layout, interfaccia utente e altre immagini visive per rendere il tuo sito web visivamente più accattivante e facile da usare",
    appDesignText:
